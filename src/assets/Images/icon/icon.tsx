export const Calendar = ({ size = 16, color = "#000000" }) => {
    return (<svg width={size} height={size} viewBox={`0 0 24 24`} fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_4418_9974)">
            ...
            <path d="M19.0499 18.0195L16.9299 20.1396" stroke={color} stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
