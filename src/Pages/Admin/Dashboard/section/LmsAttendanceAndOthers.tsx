...
const LmsAttendanceAndOthers: React.FC = () => {
  ...
  return (
    <div className="relative w-full p-6">
      ...
      <div className="fixed bottom-10 right-10 flex flex-col items-center gap-4 z-[90]">
        {isFabOpen && (
          <div className="bg-white p-3 rounded-[28px] shadow-2xl border border-slate-100 flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <button 
              onClick={() => { setActiveModal('announcement'); setIsFabOpen(false); }}
              className="group w-14 h-14 rounded-full bg-orange-50 flex items-center justify-center hover:bg-[#F27121] transition-all cursor-pointer"
            >
              <Megaphone className="text-[#F27121] group-hover:text-white" size={22} />
            </button>
            <button 
              onClick={() => { setActiveModal('instructor'); setIsFabOpen(false); }}
              className="group w-14 h-14 rounded-full bg-blue-50 flex items-center justify-center hover:bg-blue-600 transition-all cursor-pointer"
            >
              <Users className="text-blue-600 group-hover:text-white" size={22} />
            </button>
          </div>
        )}
        ...
        <button 
          ...
          className="w-16 h-16 rounded-full flex items-center justify-center bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-slate-50 hover:scale-105 transition-all cursor-pointer"
        >
          <Zap className="text-[#F27121]" size={30} strokeWidth={2.5} />
        </button>
      </div>
    </div>
  );
