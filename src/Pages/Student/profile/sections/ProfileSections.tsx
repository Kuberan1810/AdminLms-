    ...
    <div className="mx-5 mb-10">
      <div className="mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <ArrowLeft className="w-5 h-5 cursor-pointer hover:text-orange-500 transition-colors" onClick={() => navigate(-1)} />
          <h1 className="text-lg font-semibold">My Profile</h1>
        </div>

        {/* Top Profile Card */}
        <div className="bg-white rounded-2xl p-6 mb-6 flex flex-col md:flex-row items-center md:items-start gap-6 relative">
          {/* Image */}
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-semibold text-[#333333]">Name of the student</h2>
              <span className="px-2 py-0.5 rounded-md bg-[#2A9A461A] text-[#2A9A46] text-xs font-medium">
                Active
              </span>
            </div>
            <p className="text-sm text-[#626262] mt-1">Student Id</p>
            <p className="text-sm text-[#626262]">Student email</p>
          </div>
          ...
          <div className="mt-6 md:mt-0 md:absolute md:-bottom-5 md:left-1/2 md:transform md:-translate-x-1/2 bg-[#F6F6F6] p-1.5 rounded-xl flex gap-1 shadow-sm w-full md:w-auto justify-center">
            <button
              ...
              className={`flex-1 md:flex-none px-4 md:px-6 py-2 rounded-lg text-xs md:text-sm font-semibold transition-all duration-300 ease-in-out ${currentInfo === "BasicInfo"
            ...
            <button
              ...
              className={`flex-1 md:flex-none px-4 md:px-6 py-2 rounded-lg text-xs md:text-sm font-semibold transition-all duration-300 ease-in-out ${currentInfo === "AcademicInfo"
                ? "bg-white shadow-sm text-[#333333]"
                : "text-[#626262] hover:text-black hover:bg-gray-200/50"
                }`}
            >
