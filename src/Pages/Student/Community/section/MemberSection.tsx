...
const MemberSection = () => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#F2EEF4] p-4 sm:p-5 w-full overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-600">
          ...
          {onlineCount} Online
           ...
           <div className="h-px bg-gray-200 m-1" />
      ...
      <div
        className={`
          space-y-3 pr-1
          ${showAll ? "max-h-72 overflow-y-auto no-scrollbar" : ""}
        `}
      >
