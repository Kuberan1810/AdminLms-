    ...
    return (
        ...
        <div className="w-full"     >
            <div className="bg-white border border-[#F2EEF4] rounded-[10px] p-[20px]  overflow-hidden flex flex-col gap-[30px] ">
                {/* Header Bar */}
                <div className={`flex items-center ${!isCompleted ? 'justify-between' : 'gap-4'} bg-[#FFF3E9] px-[20px] h-[47px] border-b border-[#FFF3E9] -mx-[20px] -mt-[20px]`}>
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => navigate(-1)}
                            className="transition-colors flex items-center cursor-pointer p-2 hover:bg-gray-200 hover:text-white rounded-full"
                        >
                            <ArrowLeft width="20" height="20" color="#626262" />
                        </button>
