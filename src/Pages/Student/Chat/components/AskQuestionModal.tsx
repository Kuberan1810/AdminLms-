  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={`relative transition-all duration-300 ${step === "details"
        ...
        {step === "details" ? (
          <>
            ...
            <input
              ...
              className="w-full h-[50px] bg-gray-100 rounded-2xl border border-gray-200 px-4 mb-5 focus:outline-none focus:ring-1 focus:ring-orange-500"
            />
