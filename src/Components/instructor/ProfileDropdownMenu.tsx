...
const ProfileDropdownMenu = ({
    ...
    return (
        <div className="absolute right-0 mt-3 w-48 sm:w-56 rounded-2xl bg-white dark:bg-[#2A2A2A] shadow-lg border border-[#F2EEF4] dark:border-[#363636] p-2 sm:p-3 z-50">
            <button
